...
@GenericGenerator(name = "ID_GENERATOR", type = org.hibernate.id.enhanced.SequenceStyleGenerator.class, parameters = { @org.hibernate.annotations.Parameter(name = "sequence_name", value = "wf_generic_action_seq"), @Parameter(name = "increment_size", value = "1") })
...
public class GWFTransitionAction extends BaseEntity implements Comparable<GWFTransitionAction> {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), uuid, priority, conditionEl, type, description, logLevel, fieldToUpdate, asynchronous, valueEL, actionScript, notification, transition);
    }
}