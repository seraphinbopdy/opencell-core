...
@GenericGenerator(name = "ID_GENERATOR", type = org.hibernate.id.enhanced.SequenceStyleGenerator.class, parameters = { @Parameter(name = "sequence_name", value = "cpq_order_item_seq"), @Parameter(name = "increment_size", value = "1") })
public class OrderAttribute extends AttributeValue<OrderAttribute> {
    ...
    public OrderAttribute(QuoteAttribute quoteAttribute, MeveoUser currentUser) {
        ...
        assignedAttributeValue = quoteAttribute.getAssignedAttributeValue().stream().map(nestedQuoteAttribute -> {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(commercialOrder, that.commercialOrder) && Objects.equals(orderLot, that.orderLot) && Objects.equals(orderProduct, that.orderProduct) && Objects.equals(accessPoint, that.accessPoint)
