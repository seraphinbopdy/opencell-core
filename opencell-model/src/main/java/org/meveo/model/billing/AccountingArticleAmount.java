...
@GenericGenerator(name = "ID_GENERATOR", type = org.hibernate.id.enhanced.SequenceStyleGenerator.class, parameters = { @Parameter(name = "sequence_name", value = "accounting_article_amount_seq"), @Parameter(name = "increment_size", value = "1") })
@NamedQueries({ @NamedQuery(name = "AccountingArticleAmount.deleteByBillingReport", query = "DELETE FROM AccountingArticleAmount WHERE billingRunReport.id = :billingRunReportId") })
