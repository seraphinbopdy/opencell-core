...
@GenericGenerator(name = "ID_GENERATOR", type = org.hibernate.id.enhanced.SequenceStyleGenerator.class, parameters = { @Parameter(name = "sequence_name", value = "cpq_quote_lot_seq"), @Parameter(name = "increment_size", value = "1") })
...
public class QuoteLot extends BusinessCFEntity {
    ...
    public boolean equals(Object obj) {
        ...
        return duration == other.duration && Objects.equals(executionDate, other.executionDate) && Objects.equals(name, other.name) && Objects.equals(quoteVersion, other.quoteVersion);
    }
