...
public class SecurityDepositTemplateServiceTest {
    ...
    public void createSecurityDepositTemplateService() {
        ...
        Mockito.doNothing().when(securityDepositTemplateService).create(securityDepositTemplate);
        securityDepositTemplateService.create(securityDepositTemplate);
    }
    ...
    public void updateSecurityDepositTemplateService() {
        ...
        securityDepositTemplate.setMinAmount(BigDecimal.valueOf(100));
        securityDepositTemplate.setMinAmount(BigDecimal.valueOf(1000));
        Mockito.doReturn(null).when(securityDepositTemplateService).update(securityDepositTemplate);
        securityDepositTemplateService.update(securityDepositTemplate);
    }
    ...
    public void checkSecurityDepositTemplateService_currency_null() {
        ...
        try {
            Mockito.doReturn(new FinanceSettings()).when(financeSettingsService).getFinanceSetting();
    ...
    public void updateStatus() {
        ...
        Mockito.doReturn(securityDepositTemplate).when(securityDepositTemplateService).findById(Mockito.any());
        Mockito.doReturn(securityDepositTemplate).when(securityDepositTemplateService).update(Mockito.any());

        securityDepositTemplateService.updateStatus(Collections.singleton(1L), "DRAFT");
    }
