...
@GenericGenerator(name = "ID_GENERATOR", type = org.hibernate.id.enhanced.SequenceStyleGenerator.class, parameters = { @Parameter(name = "sequence_name", value = "cpq_commercial_rule_item_seq"), @Parameter(name = "increment_size", value = "1") })
public class CommercialRuleItem extends BaseEntity {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(getCommercialRuleHeader(), other.getCommercialRuleHeader()) && Objects.equals(getCommercialRuleLines(), other.getCommercialRuleLines()) && operator == other.operator
