...
public class Header {
    ...
    @XmlElement
    private Integer opportunityDuration;
    @XmlElement
    ...
    public Header(BillingAccount billingAccount, Contract contract, int quoteVersion, String quoteCode, Date startDate, Long duration, Integer opportunityDuration, String customerReference, String registrationNumber,
     ...
     */
    public Integer getOpportunityDuration() {
     ...
     */
    public void setOpportunityDuration(Integer opportunityDuration) {
        this.opportunityDuration = opportunityDuration;
    }
