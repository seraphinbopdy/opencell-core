...
@GenericGenerator(name = "ID_GENERATOR", type = org.hibernate.id.enhanced.SequenceStyleGenerator.class, parameters = { @Parameter(name = "sequence_name", value = "cpq_quote_article_line_seq"), @Parameter(name = "increment_size", value = "1") })
public class QuoteArticleLine extends AuditableEntity {
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof QuoteArticleLine))
            return false;
