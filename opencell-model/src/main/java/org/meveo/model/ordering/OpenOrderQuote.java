...
@GenericGenerator(name = "ID_GENERATOR", type = org.hibernate.id.enhanced.SequenceStyleGenerator.class, parameters = { @Parameter(name = "sequence_name", value = "open_order_quote_seq"), @Parameter(name = "increment_size", value = "1") })
@NamedQueries({ @NamedQuery(name = "OpenOrderQuote.findByOpenOrderTemplate", query = "select o from OpenOrderQuote o where o.openOrderTemplate = :openOrderTemplate") })
