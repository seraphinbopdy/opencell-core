...
public enum PriceTypeEnum {
    ...
    RECURRING("recurring"), ONE_SHOT_SUBSCRIPTION("oneShot_subscription"), ONE_SHOT_TERMINATION("oneShot_termination"), ONE_SHOT_OTHER("oneShot_other"), ONE_SHOT_INVOICING_PLAN("oneShot_invoicingPlan"), USAGE(
            "usage"), FIXED_DISCOUNT("fixed discount");
