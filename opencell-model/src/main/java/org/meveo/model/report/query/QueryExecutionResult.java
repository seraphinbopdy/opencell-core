...
@GenericGenerator(name = "ID_GENERATOR", type = org.hibernate.id.enhanced.SequenceStyleGenerator.class, parameters = { @Parameter(name = "sequence_name", value = "query_result_seq"), @Parameter(name = "increment_size", value = "1") })
@NamedQueries({ @NamedQuery(name = "QueryExecutionResult.findIdsByReportQuery", query = "select qer.id from QueryExecutionResult qer where qer.reportQuery = :reportQuery") })
