...
public class GroupedAttributes extends EnableBusinessCFEntity {
    ...
    @JoinTable(name = "cpq_grouped_attributes_attribute", joinColumns = @JoinColumn(name = "grouped_attributes", referencedColumnName = "id"), inverseJoinColumns = @JoinColumn(name = "attribute_id", referencedColumnName = "id"))
