...
@GenericGenerator(name = "ID_GENERATOR", type = org.hibernate.id.enhanced.SequenceStyleGenerator.class, parameters = { @Parameter(name = "sequence_name", value = "cpq_trading_price_plan_matrix_line_sq"), @Parameter(name = "increment_size", value = "1") })
@NamedQueries({ @NamedQuery(name = "TradingPricePlanMatrixLine.enableOrDisable", query = "UPDATE TradingPricePlanMatrixLine set useForBillingAccounts =:enable where id in (:ids)"),
...
public class TradingPricePlanMatrixLine extends AuditableEntity {
    ...
    public int hashCode() {
        ...
        result = prime * result + Objects.hash(pricePlanMatrixLine, rate, tradingCurrency, tradingValue, useForBillingAccounts);
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(pricePlanMatrixLine, other.pricePlanMatrixLine) && Objects.equals(rate, other.rate) && Objects.equals(tradingCurrency, other.tradingCurrency)
                && Objects.equals(tradingValue, other.tradingValue) && useForBillingAccounts == other.useForBillingAccounts;
    }
