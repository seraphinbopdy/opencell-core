...
@NamedQueries({ @NamedQuery(name = "ProductLine.findByCode", query = "select p from ProductLine p where p.code =:code") })
public class ProductLine extends BusinessCFEntity {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(longDescription, other.longDescription) && Objects.equals(parentLine, other.parentLine) && Objects.equals(seller, other.seller);
    }
}
