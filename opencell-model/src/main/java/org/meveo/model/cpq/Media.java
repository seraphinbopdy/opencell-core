...
@GenericGenerator(name = "ID_GENERATOR", type = org.hibernate.id.enhanced.SequenceStyleGenerator.class, parameters = { @Parameter(name = "sequence_name", value = "cpq_media_seq"), @Parameter(name = "increment_size", value = "1") })
...
//        this.cfAccumulatedValues = copy.cfAccumulatedValues;
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(label, other.label) && Objects.equals(main, other.main) && Objects.equals(mediaName, other.mediaName) && Objects.equals(mediaPath, other.mediaPath) && mediaType == other.mediaType;
    }
