...
public class DocumentCategory extends BusinessCFEntity {
    ...
    /**
     * a text EL (has access to variables "document" and "entity" containing the document category) returning a subdirectory for the document category (relative to "document.rootDir")
     */
