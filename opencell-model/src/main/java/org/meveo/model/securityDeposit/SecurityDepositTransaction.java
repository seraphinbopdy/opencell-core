...
@GenericGenerator(name = "ID_GENERATOR", type = org.hibernate.id.enhanced.SequenceStyleGenerator.class, parameters = { @Parameter(name = "sequence_name", value = "security_deposit_transaction_seq"), @Parameter(name = "increment_size", value = "1") })
@NamedQueries({ @NamedQuery(name = "SecurityDepositTransaction.getSecurityDepositCodesByAoId", query = "SELECT sd.securityDeposit.code FROM SecurityDepositTransaction sd WHERE sd.accountOperation.id = :aoId") })
