...
public class EndpointExecutionBuilder {
    ...
    public EndpointExecution createEndpointExecution() {
        return new EndpointExecution(parameters, resp, pathInfo, keep, wait, method, persistenceContextId, persistenceContext, budgetUnit, bugetMax, delayUnit, delayValue, request, endpoint, pendingResult);
    }
    ...
    public EndpointExecutionBuilder setPendingResult(PendingResult pendingResult) {
