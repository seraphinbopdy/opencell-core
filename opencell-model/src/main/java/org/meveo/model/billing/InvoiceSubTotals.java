...
@GenericGenerator(name = "ID_GENERATOR", type = org.hibernate.id.enhanced.SequenceStyleGenerator.class, parameters = { @Parameter(name = "sequence_name", value = "invoice_sub_totals_seq"), @Parameter(name = "increment_size", value = "1") })
@NamedQueries(value = { @NamedQuery(name = "InvoiceSubTotals.findByInvoiceType", query = "select iv From InvoiceSubTotals iv where iv.invoiceType=:invoiceType") })
