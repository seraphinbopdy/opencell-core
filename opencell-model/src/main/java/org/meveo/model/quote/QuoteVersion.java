...
@GenericGenerator(name = "ID_GENERATOR", type = org.hibernate.id.enhanced.SequenceStyleGenerator.class, parameters = { @Parameter(name = "sequence_name", value = "cpq_quote_version_seq"), @Parameter(name = "increment_size", value = "1") })
...
public class QuoteVersion extends AuditableCFEntity implements IReferenceEntity {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(invoicingPlan, other.invoicingPlan) && Objects.equals(endDate, other.endDate) && Objects.equals(id, other.id) && Objects.equals(quote, other.quote)
                && Objects.equals(quoteVersion, other.quoteVersion) && Objects.equals(startDate, other.startDate) && status == other.status && Objects.equals(statusDate, other.statusDate);
    }
