...
@GenericGenerator(name = "ID_GENERATOR", type = org.hibernate.id.enhanced.SequenceStyleGenerator.class, parameters = { @Parameter(name = "sequence_name", value = "cpq_contract_item_seq"), @Parameter(name = "increment_size", value = "1") })
@NamedQueries({ @NamedQuery(name = "ContractItem.getApplicableContracts", query = "select c from ContractItem c left join c.targetAccountingArticles article where  c.contract.id=:contractId "
        + " and (c.offerTemplate is null or c.offerTemplate.id=:offerId) " + " and (:productId is null or c.product is null or c.product.id=:productId) "
        + " and (c.chargeTemplate is null or c.chargeTemplate.id=:chargeTemplateId) " + " and ((c.targetAccountingArticles is empty and c.chargeTemplate is not null) or article.id =:accountingArticleId)", hints = {
...
public class ContractItem extends EnableBusinessCFEntity {
    ...
    public int hashCode() {
        ...
        result = prime * result + Objects.hash(amountWithoutTax, chargeTemplate, offerTemplate, contract, pricePlan, product, rate, serviceTemplate);
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(amountWithoutTax, other.amountWithoutTax) && Objects.equals(chargeTemplate, other.chargeTemplate) && Objects.equals(offerTemplate, other.offerTemplate)
                && Objects.equals(contract, other.contract) && Objects.equals(pricePlan, other.pricePlan) && Objects.equals(product, other.product) && rate == other.rate
